...
#from django.conf.urls import url #kanske inte behövs, path ersätter
...
urlpatterns = [
    ...
    path('signup/', accounts_views.signup, name='signup'), #1
    ...
    name='password_reset_confirm'), #changed this slightly
